...
by our current hypotheses, namely that \mintinline{coq}{Empty ||= p} and \mintinline{coq}{(A; Empty |-- p) -> False} (which includes showing that all formulas in the empty set are valid).
