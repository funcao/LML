...
\mintinline{coq}{F} (we recall that \mintinline{coq}{W F} is Coq's syntax for
...
the verification of a simple low-level virtual machine, and the other is the
subset of Sequential Cminor.
...
interpretation of several modal logic systems. Whether or not the current implementation
